...
<nav class="navbar navbar-expand-lg shadow-sm">
    <div class="container-fluid">
        <a class="navbar-brand brand__name"> Rockerfella <span class="brand__icon"><i class="bi bi-controller"></i></span></a>
        <ul class="navbar-nav">
            <li class="nav-item">
                    ...
                    <div class="row justify-content-center ">
                        ...
                        <div class="col-md-6 align-item-center">
                            <form method="POST" action="${pageContext.request.contextPath}/registration-servlet">
                                ...
                                <input type="password" id="cpassword" class="form-control mb-2"  placeholder="Confirm your password..." name="cpassword" required>
                                <h6 class="text-danger">I am already a Rockerfella! <span><a href="login.jsp">Login</a></span></h6>
